...
//    __weak typeof(context) _context=context;
    [[NSNotificationCenter defaultCenter] addObserverForName:@"loadSplashAdObserver" object:nil queue:NSOperationQueue.mainQueue usingBlock:^(NSNotification * _Nonnull note) {
...
- (void)splashAdDidLoad:(BUSplashAdView *)splashAd {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"loadSplashAdObserver" object:@{@"evenType":@"onAdLoad",@"adEvenType":@"onAddLoaded",@"msg":@"广告加载成功！",@"code":@1}];
}
...
- (void)splashAdDidClose:(BUSplashAdView *)splashAd {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"loadSplashAdObserver" object:@{@"evenType":@"onAdLoad",@"adEvenType":@"onAdClosed",@"msg":@"广告关闭成功！",@"code":@1}];
...
- (void)splashAdDidClick:(BUSplashAdView *)splashAd {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"loadSplashAdObserver" object:@{@"evenType":@"onAdLoad",@"adEvenType":@"onAdClicked",@"msg":@"广告被点击了！",@"code":@1}];
    // Be careful not to say 'self.splashadview = nil' here.
    // Subsequent agent callbacks will not be triggered after the 'splashAdView' is released early.
    [splashAd removeFromSuperview];
...
- (void)splashAdDidClickSkip:(BUSplashAdView *)splashAd {
    [[NSNotificationCenter defaultCenter] postNotificationName:@"loadSplashAdObserver" object:@{@"evenType":@"onAdLoad",@"adEvenType":@"onAdSkipClicked",@"msg":@"广告跳过被点击了！",@"code":@1}];
...
- (void)splashAd:(BUSplashAdView *)splashAd didFailWithError:(NSError *)error {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"loadSplashAdObserver" object:@{@"evenType":@"onError",@"adEvenType":@"",@"msg":error.userInfo,@"code":@0}];
}

- (void)splashAdWillVisible:(BUSplashAdView *)splashAd {
//    [[NSNotificationCenter defaultCenter] postNotificationName:@"loadSplashAdObserver" object:@{@"evenType":@"onAdLoad",@"adEvenType":@"onAdWillShow",@"msg":@"广告将显示！",@"code":@1}];
    [self pbu_logWithSEL:_cmd msg:@"splashAd will Visible"];
}
...
//    [[NSNotificationCenter defaultCenter] postNotificationName:@"loadSplashAdObserver" object:@{@"evenType":@"onAdLoad",@"adEvenType":@"onAdWillClose",@"msg":@"广告将关闭！",@"code":@1}];
    [self pbu_logWithSEL:_cmd msg:@"splashAd will close"];
}
...
- (void)splashAdCountdownToZero:(BUSplashAdView *)splashAd {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"loadSplashAdObserver" object:@{@"evenType":@"onAdLoad",@"adEvenType":@"onAdTimeOver",@"msg":@"倒计时结束！",@"code":@1}];
    if (!splashAd.zoomOutView) {
        [self removeSplashAdView];
    }
